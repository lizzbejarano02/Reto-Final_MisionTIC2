...
public class GestionarSucursalesForm extends javax.swing.JDialog {
    ...
    public void recibeDatosDireccion(int idDireccion, int idSucursal, String departamento, String sucursal, String zona, String tipoCalle, String numero1, String numero2, String numero3) {
    ...
    public void actualizarSucursalDireccion() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String sucursales = txtNuevaSucursal.getText();
                if (sucursal.isEmpty()){
                    sucursal = txtSucursal.getText();
                }else{
                   String queryActualizarSucursal = "UPDATE `sucursal` SET `nombreSucursal`='" + sucursales + "' WHERE `idSucursal` = " + idSucursal + ";";
                try{
